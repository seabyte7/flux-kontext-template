...
import {
  StandardTurnstile,
  verifyStandardTurnstileToken,
} from "@/components/StandardTurnstile";
...
export function FluxKontextGenerator() {
  ...
  const [selectedModel, setSelectedModel] = useState<
    "pro" | "max" | "schnell" | "dev" | "realism" | "anime"
  >("pro");
  ...
  }, [userType, userLimits.maxImages, availableModels.length, session]); // ?? 修复依赖
  ...
  // ?? ����ģ�͵�API������ӳ��
  const getActionForModel = useCallback(
    (
      model: string,
      hasImages: boolean,
    ...
    if (hasImages) {
      ...
      const editingModels = [
        {
          ...
          description:
            "Fast iterative editing, maintains character consistency",
          credits: 16, // 🔧 ¼ƷѣPROϵ16
          speed: "Fast (6-10s)",
          quality: "Good",
          features: [
      ...
      if (isMultiImage) {
        editingModels.push({
          ...
          description:
            "Experimental multi-image editing with character consistency",
      ...
      return [
        ...
        },
        {
          ...
          description:
            "Best quality with enhanced prompt adherence and typography",
          credits: 32, // 🔧 ¼ƷѣMAXϵ32
          speed: "Slower (10-15s)",
          quality: "Excellent",
          features: [
  ...
  const getRecommendedModel = useCallback(() => {
    ...
    return (
      recommended?.value || models.find((m) => m.available)?.value || "pro"
    );
  ...
  }, [uploadedImages.length, getRecommendedModel, selectedModel]); // ?? 修复依赖
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="flex flex-col py-2">
        {/* 🔧 生成图像标题 */}
        <header className="mb-3">{/* 🔧 生成图像展示 */}</header>
              ...
              <div className="space-y-3">
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-base text-yellow-300/80 mb-2">
                    Create and edit professional images with advanced AI
                    technology
                  </p>
                    ...
                    <div className="mt-2 p-2 bg-blue-50 border border-blue-200 rounded text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-blue-700 text-xs">
                          Multi-image editing detected. Using experimental
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          const currentPrompt =
                            uploadedImages.length > 0 ? editPrompt : textPrompt;
                          ...
                          if (!currentPrompt.trim()) {
                            ...
                            const optimizedPrompt =
                              aiOptimizedPrompts[
                                Math.floor(
                                  Math.random() * aiOptimizedPrompts.length,
                                )
                              ];
                            if (uploadedImages.length > 0) {
                            ...
                            const enhancement = usePrefix
                              ? enhancementPrefix[
                                  Math.floor(
                                    Math.random() * enhancementPrefix.length,
                                  )
                                ] +
                                currentPrompt +
                                enhancementSuffixes[
                                  Math.floor(
                                    Math.random() * enhancementSuffixes.length,
                                  )
                                ]
                              : currentPrompt +
                                enhancementSuffixes[
                      ...
                      <div className="mt-1 text-xs text-yellow-300/70 bg-blue-50/10 border border-blue-200/20 rounded p-2">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-blue-300">
                            Image editing may preserve original proportions.
                            Output ratio provides guidance but final size
                            depends on input image.
                          </span>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="col-span-1 md:col-span-1">
                    {isTurnstileEnabled && checkTurnstileRequired() ? (
                      <div>
                        ...
                        <div
                          className="bg-muted/30 p-2 rounded h-16 flex items-center justify-center relative"
                          ref={turnstileRef}
                        >
                          {isTurnstileVerified ? (
                            // 🔧 验证成功状态
                    ...
                    <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          const cardElement = (document.activeElement?.closest(
                            ".group",
                          ) ||
                    ...
                    <div className="grid grid-cols-3 gap-1 mb-2">
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          const linkToCopy =
                            (image as any).fal_url || image.url;
